import { TextField, Suffix } from '../src';
...
If you wish to use a suffix you must first import the Suffix component.

```js
import { Suffix } from '@fabric-ds/react';
```

Then you include as a child of TextField like so:
...
```props packages/textfield/src/suffix.tsx
