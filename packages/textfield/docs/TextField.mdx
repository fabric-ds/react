import { TextField, Affix } from '../src';
...
Then you include as a child of TextField like so and pass the appropiate types
(see bottom of this page for types)
...
```props packages/textfield/src/affix.tsx
